...
import gpc.controller.WebController;
...
public class FileService {
	...
	public List<Statement> mapStatmentObject(String charStream) {
	...
	public List<Turnover> mapTurnoverObject(String charStream) {
